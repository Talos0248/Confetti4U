...
function Message() {
    ...
    const defaultMessage = {
        ...
        additionalText: "Someone wanted to send you a message, but an error occurred!\nAt least it's the thought that counts, right?",
        music: ""
                ...
                : (
                    <div className="main-message">
                        <div className="message">
                            <h2>{colorStrings(message.mainText, message.confettiType ? message.confettiType : "regular", isDark)}</h2>
